...
public class TestSoftList  extends AndroidTestCase
{
	...
	public void testAd2()
	   {
		try
		{
			String json = getJsonOrmliteByReadLocal("json2.txt");
			...
			{
				System.out.println(detail.getId()+"  title="+detail.getContent().title+"  apk="+detail.getApp().getAppInstallPkgItem());
    ...
    public String getJsonOrmliteByReadLocal(String name) 
    {
  	  String json=null;
