 ...
 *
 */
public class TopTabbarTwoNew extends LinearLayout implements OnClickListener {
	...
	public TopTabbarTwoNew(Context context,AttributeSet attr) {
		super(context);
		
		this.setOrientation(LinearLayout.HORIZONTAL); 
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View view = inflater.inflate(R.layout.tabbartwonew, this);
	...
	private void onClick(int id) {
		...
		case R.id.tabbar_linearlayout_secondItemClick:
			//set whitch tab view should light .
			firstItem.setBackgroundResource(0);
			secondItem.setBackgroundResource(R.drawable.tab_selected_newy);
