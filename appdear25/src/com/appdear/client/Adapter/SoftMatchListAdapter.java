 ...
 * 匹配（万花筒）列表首页
 */
public class SoftMatchListAdapter extends BaseAdapter {
	Context mContext = null;
	List<CatalogListInfo>  mSoftCategory = null;
	LayoutInflater mLayoutInflater = null;
	ListViewRefresh list;
	public SoftMatchListAdapter(Context context,List<CatalogListInfo> categoryList, ListViewRefresh list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView != null) {
			...
			view = mInflater.inflate(R.layout.softmatch_listitem_layout, parent, false);
		}
		CategoryHolder holder = (CategoryHolder) view.getTag();
		if (holder == null) {
			holder = new CategoryHolder();
			holder.imgIcon = (AsynLoadImageView) view.findViewById(R.id.match_image);
			//holder.tvTip = (TextView) view.findViewById(R.id.category_tip);
			holder.tvTitle = (TextView) view.findViewById(R.id.match_title);
